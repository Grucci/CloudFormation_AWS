...
variable "environment_name" {
  description = "The root name of the environment being created"
}
...
#TODO: Add support for selecting where VPC flow logs are created (currently supports only CloudWatch and does not support S3)
...
/* COMPUTED VARIABLE IN CUSTOM MODULE
variable "name" {
...
/* COMPUTED VARIABLES IN CUSTOM MODULE
variable "igw_tags" {
